...
var fetch = sdk_1.Builder.isBrowser ? window.fetch : require('node-fetch');
var sizeMap = {
    desktop: 'large',
    tablet: 'medium',
    mobile: 'small',
...
function decorator(fn) {
    return function argReceiver() {
        ...
        function descriptorChecker(target, key, descriptor) {
            ...
            return __assign(__assign({}, descriptor), (_a = {}, _a[descriptorKey] = fn.apply(void 0, __spreadArray([descriptor[descriptorKey]], fnArgs, false)), _a));
        }
    };
}
var fetchCache = {};
...
var BuilderComponent = /** @class */ (function (_super) {
    ...
    function BuilderComponent(props) {
        ...
        _this.messageListener = function (event) {
            ...
            switch (info.type) {
                ...
                case 'builder.resetState': {
                    var _a = info.data, state = _a.state, model = _a.model;
                    if (model === _this.name) {
                ...
                case 'builder.resetSymbolState': {
                    var _b = info.data.state, state = _b.state, model = _b.model, id = _b.id;
        ...
        _this.onContentLoaded = function (data, content) {
            ...
            if (data && data.state) {
                var newState = __assign(__assign({}, _this.state), { updates: ((_this.state && _this.state.updates) || 0) + 1, state: Object.assign(_this.rootState, __assign(__assign(__assign(__assign({}, _this.state.state), { location: _this.locationState, deviceSize: _this.deviceSizeState, device: _this.device }), data.state), _this.props.data)) });
                if (_this.mounted) {
                    ...
                    var _loop_1 = function (key) {
                        ...
                        if (url && (!_this.data[key] || sdk_1.Builder.isEditing)) {
                            ...
                            if (sdk_1.Builder.isBrowser) {
                                ...
                                if (false && sdk_1.Builder.isEditing && model && _this.builder.editingModel === model) {
    ...
    Object.defineProperty(BuilderComponent.prototype, "deviceSizeState", {
        ...
        get: function () {
            ...
            return sdk_1.Builder.isBrowser
                ? device_sizes_constant_1.sizes.getSizeForWidth(window.innerWidth)
    ...
    Object.defineProperty(BuilderComponent.prototype, "data", {
        get: function () {
            var _a;
            var data = __assign(__assign(__assign({}, (this.inlinedContent && ((_a = this.inlinedContent.data) === null || _a === void 0 ? void 0 : _a.state))), this.props.data), this.state.state);
    ...
    BuilderComponent.prototype.componentDidUpdate = function (prevProps) {
        ...
        if (this.props.data && prevProps.data !== this.props.data) {
            this.state.update(function (state) {
                Object.assign(state, _this.props.data);
            });
        }
        if (sdk_1.Builder.isEditing) {
    ...
    BuilderComponent.prototype.render = function () {
        ...
        var dataString = sdk_1.Builder.isBrowser && this.props.data && size(this.props.data) && (0, hash_sum_1.default)(this.props.data);
            ...
            react_1.default.createElement(builder_meta_1.BuilderMetaContext.Consumer, null, function (value) { return (react_1.default.createElement(builder_meta_1.BuilderMetaContext.Provider, { value: typeof _this.props.ampMode === 'boolean'
                ...
                react_1.default.createElement(builder_async_requests_1.BuilderAsyncRequestsContext.Consumer, null, function (value) {
                    ...
                    return (react_1.default.createElement(builder_content_component_1.BuilderContent, { isStatic: _this.props.isStatic || sdk_1.Builder.isStatic, key: ((_a = _this.inlinedContent) === null || _a === void 0 ? void 0 : _a.id) ||
                        ...
                        // TODO: pass entry in
                        contentLoaded: function (data, content) { return _this.onContentLoaded(data, content); }, options: __assign(__assign(__assign(__assign(__assign({ key: key, entry: _this.props.entry }, (content && { initialContent: [content] })), (!content &&
                            'content' in _this.props &&
                            !_this.isPreviewing && { initialContent: [] })), (_this.props.url && { url: _this.props.url })), _this.props.options), (_this.options.codegen && {
                            format: 'react',
                        ...
                        return data ? (react_1.default.createElement("div", { "data-builder-component": _this.name, "data-builder-content-id": fullData.id, "data-builder-variation-id": fullData.testVariationId || fullData.variationId || fullData.id },
