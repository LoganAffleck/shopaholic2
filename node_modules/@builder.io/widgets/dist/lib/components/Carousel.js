...
var CarouselComponent = /** @class */ (function (_super) {
    ...
    CarouselComponent.prototype.render = function () {
        ...
        return (React.createElement(react_1.BuilderAsyncRequestsContext.Consumer, null, function (value) {
            ...
            return (React.createElement(react_1.BuilderStoreContext.Consumer, null, function (state) { return (React.createElement("div", { ref: _this.divRef, className: "builder-carousel" },
                ...
                React.createElement(react_slick_1.default, __assign({ responsive: _this.props.responsive, ref: _this.sliderRef, afterChange: function (slide) {
                        var _a;
                        // TODO; callbacks
                        if (_this.divRef) {
                                ...
                                if (Array.isArray(array)) {
                                    ...
                                    return array.map(function (data, index) {
                                        ...
                                        return (React.createElement(react_1.BuilderStoreContext.Provider, { key: block.id, value: __assign(__assign({}, state), { state: childState }) },
                                            React.createElement(react_1.BuilderBlockComponent, { block: __assign(__assign({}, block), { repeat: null }), index: index, child /* TODO: fieldname? */: true })));
                                    });
                                }
                            }
                            return (React.createElement(react_1.BuilderBlockComponent, { key: block.id, block: block, index: index, child /* TODO: fieldname? */: true }));
                        })
                    : _this.props.slides &&
