...
var CarouselComponent = /** @class */ (function (_super) {
    tslib.__extends(CarouselComponent, _super);
    ...
    CarouselComponent.prototype.render = function () {
        ...
        if (slides && !react.Builder.isBrowser) {
            slides = slides.slice(0, 1);
        }
        return (React.createElement(react.BuilderAsyncRequestsContext.Consumer, null, function (value) {
            _this._errors = value && value.errors;
            _this._logs = value && value.logs;
            return (React.createElement(react.BuilderStoreContext.Consumer, null, function (state) { return (React.createElement("div", { ref: _this.divRef, className: "builder-carousel" },
                react.Builder.isServer ? (React.createElement("style", { type: "text/css", dangerouslySetInnerHTML: { __html: slickStyles } })) : (React.createElement("style", { type: "text/css" }, slickStyles)),
                React.createElement(Slider__default['default'], tslib.__assign({ responsive: _this.props.responsive, ref: _this.sliderRef, afterChange: function (slide) {
                        var _a;
                        // TODO; callbacks
                        if (_this.divRef) {
                    ...
                    nextArrow: React.createElement("div", null,
                        React.createElement(react.BuilderBlocks, { parentElementId: _this.props.builderBlock.id, dataPath: "component.options.prevButton", blocks: _this.props.prevButton })), 
                    // OOF!!
                    prevArrow: React.createElement("div", null,
                        React.createElement(react.BuilderBlocks, { parentElementId: _this.props.builderBlock.id, dataPath: "component.options.nextButton", blocks: _this.props.nextButton })) }, _this.props.slickProps), _this.props.useChildrenForSlides
                    ? _this.props.builderBlock &&
                        ...
                        _this.props.builderBlock.children.map(function (block, index) {
                            if (block.repeat && block.repeat.collection) {
                                ...
                                var array = react.stringToFunction(collectionPath, true, _this._errors, _this._logs)(state.state);
                                if (Array.isArray(array)) {
                                    if (!react.Builder.isBrowser) {
                                        array = array.slice(0, 1);
                                    }
                                    return array.map(function (data, index) {
                                        var _a;
                                        // TODO: Builder state produce the data
                                        var childState = tslib.__assign(tslib.__assign({}, state.state), (_a = {}, _a[itemName_1] = data, _a.$index = index, _a.$item = data, _a));
                                        return (React.createElement(react.BuilderStoreContext.Provider, { key: block.id, value: tslib.__assign(tslib.__assign({}, state), { state: childState }) },
                                            React.createElement(react.BuilderBlockComponent, { block: tslib.__assign(tslib.__assign({}, block), { repeat: null }), index: index, child /* TODO: fieldname? */: true })));
                                    });
                                }
                            }
                            return (React.createElement(react.BuilderBlockComponent, { key: block.id, block: block, index: index, child /* TODO: fieldname? */: true }));
                        })
                    : _this.props.slides &&
                        ...
                        React.createElement(react.BuilderBlocks, { key: index, parentElementId: _this.props.builderBlock && _this.props.builderBlock.id, dataPath: "component.options.slides." + index + ".content", child: true, blocks: slide.content || slide })); })))); }));
        }));
    };
...
var TabsComponent = /** @class */ (function (_super) {
    tslib.__extends(TabsComponent, _super);
    ...
    Object.defineProperty(TabsComponent.prototype, "activeTab", {
        ...
        set: function (tab) {
            this.setState(tslib.__assign(tslib.__assign({}, this.state), { activeTab: tab }));
        },
        enumerable: true,
        configurable: true
    });
    TabsComponent.prototype.render = function () {
        ...
        return (React.createElement(React.Fragment, null,
            React.createElement("span", { style: {
                ...
                this.props.tabs.map(function (item, index) { return (React.createElement("span", { key: index, className: 'builder-tab-wrap ' + (_this.activeTabSpec === item ? 'builder-tab-active' : ''), style: tslib.__assign({}, ((_this.activeTabSpec === item && _this.props.activeTabStyle) || undefined)), onClick: function () {
                    ...
                    React.createElement(react.BuilderBlocks
            ...
            this.activeTabSpec && (React.createElement(react.BuilderBlocks, { parentElementId: this.props.builderBlock.id, dataPath: "component.options.tabs." + this.state.activeTab + ".content", blocks: this.activeTabSpec.content }))));
    };
...
var AccordionComponent = /** @class */ (function (_super) {
    tslib.__extends(AccordionComponent, _super);
    ...
    AccordionComponent.prototype.getAccordionItem = function (titleBlocks, detailBlocks, index, openGridItemOrder, onlyOneAtATime, fromChildren) {
        ...
        React.createElement(React.Fragment, { key: index },
            React.createElement("div", { className: "builder-accordion-title builder-accordion-title-" + (open ? 'open' : 'closed'), style: tslib.__assign({ cursor: 'pointer', display: 'flex', flexDirection: 'column', alignItems: 'stretch' }, (grid && tslib.__assign({ width: this.props.gridRowWidth }, (typeof openGridItemOrder === 'number' && {
                    order: index < openGridItemOrder ? index : index + 1,
                })))), "data-index": index, onClick: function () {
                    if (open) {
                        _this.setState(tslib.__assign(tslib.__assign({}, _this.state), { open: onlyOneAtATime ? [] : _this.state.open.filter(function (item) { return item !== index; }) }));
                    }
                    else {
                        _this.setState(tslib.__assign(tslib.__assign({}, _this.state), { open: onlyOneAtATime ? [index] : _this.state.open.concat(index) }));
                    }
                } }, fromChildren ? (titleBlocks.map(function (block, index) { return (React.createElement(react.BuilderBlockComponent, { key: index, block: tslib.__assign(tslib.__assign({}, block), { repeat: null }), index: index, child: true })); })) : (React.createElement(react.BuilderBlocks, { blocks: titleBlocks, dataPath: "items." + index + ".title" }))),
            open && (React.createElement("div", { className: "builder-accordion-detail builder-accordion-detail-" + (open ? 'open' : 'closed'), style: tslib.__assign({ order: typeof openGridItemOrder === 'number' ? openGridItemOrder : undefined }, (grid && {
                    width: '100%',
                })) }, open &&
                (fromChildren ? (detailBlocks.map(function (block, index) { return (React.createElement(react.BuilderBlockComponent, { key: index, block: tslib.__assign(tslib.__assign({}, block), { repeat: null }), index: index, child: true })); })) : (React.createElement(react.BuilderBlocks, { blocks: detailBlocks, dataPath: "items." + index + ".detail" })))))));
    };
    AccordionComponent.prototype.render = function () {
        ...
        return (React.createElement(react.BuilderAsyncRequestsContext.Consumer, null, function (value) {
            _this._errors = value && value.errors;
            _this._logs = value && value.logs;
            return (React.createElement(react.BuilderStoreContext.Consumer, null, function (state) { return (React.createElement("div", { ref: function (ref) { return (_this.divRef = ref); }, className: "builder-accordion", style: tslib.__assign({ display: 'flex', alignItems: 'stretch', flexDirection: 'column' }, (grid && {
                    flexDirection: 'row',
                        ...
                        if (block.repeat && block.repeat.collection) {
                            ...
                            if (Array.isArray(array)) {
                                return array.map(function (data, index) {
                                    var _a;
                                    // TODO: Builder state produce the data
                                    var childState = tslib.__assign(tslib.__assign({}, state.state), (_a = { $index: index, $item: data }, _a[itemName_1] = data, _a));
                                    return (React.createElement(react.BuilderStoreContext.Provider, { key: block.id, value: tslib.__assign(tslib.__assign({}, state), { state: childState }) }, _this.getAccordionItem(block.children ? [block.children[0]] : [], block.children ? [block.children[1]] : [], index, openGridItemOrder, onlyOneAtATime, true)));
                                });
                            }
                        }
...
var MasonryComponent = /** @class */ (function (_super) {
    tslib.__extends(MasonryComponent, _super);
    ...
    MasonryComponent.prototype.render = function () {
        ...
        return (React.createElement("div", { style: {
                opacity: react.Builder.isBrowser && this.state.layoutComplete ? 1 : 0,
                transition: 'opacity 0.2s',
            } },
            React.createElement(react.BuilderAsyncRequestsContext.Consumer, null, function (value) {
                _this._errors = value && value.errors;
                _this._logs = value && value.logs;
                return (React.createElement(react.BuilderStoreContext.Consumer, null, function (state) { return (React.createElement("div", { ref: function (ref) { return (_this.divRef = ref); }, className: "builder-masonry" },
                    React.createElement(Masonry__default['default'], { onLayoutComplete: function () {
                            if (!_this.state.layoutComplete) {
                                _this.setState(tslib.__assign(tslib.__assign({}, _this.state), { layoutComplete: true }));
                            }
                        }, options: {
                                    ...
                                    if (Array.isArray(array)) {
                                        ...
                                        return array.map(function (data, index) {
                                            ...
                                            return (React.createElement("div", { className: "masonry-item", style: itemStyle },
                                                React.createElement(react.BuilderStoreContext.Provider, { key: block.id, value: tslib.__assign(tslib.__assign({}, state), { state: childState }) },
                                                    React.createElement(react.BuilderBlockComponent, { block: tslib.__assign(tslib.__assign({}, block), { repeat: null }), index: index, child: true }))));
                                        });
                                    }
                                }
                                return (React.createElement("div", { style: itemStyle, className: "masonry-item" },
                                    React.createElement(react.BuilderBlockComponent, { key: block.id, block: block, index: index, child: true })));
                            })
                        : _this.props.tiles &&
                            ...
                            React.createElement("div", { style: itemStyle, className: "masonry-item" },
                                React.createElement(react.BuilderBlocks, { key: index, parentElementId: _this.props.builderBlock && _this.props.builderBlock.id, dataPath: "component.options.tiles." + index + ".content", child: true, blocks: tile.content || tile }))); })))); }));
            })));
    };
...
var carouselConfig = {
    ...
    inputs: [
        ...
        },
        {
            ...
            hideFromUI: true,
            defaultValue: [
                tslib.__assign(tslib.__assign({}, defaultButton), { component: {
                        name: 'Image',
                        options: {
    ...
    inputs: [
        {
            ...
            defaultValue: [
                {
                    label: [
                        tslib.__assign(tslib.__assign({}, defaultTab), { component: {
                                name: 'Text',
                                options: {
                                    text: 'Tab 1',
                                },
                    ...
                    content: [
                        tslib.__assign(tslib.__assign({}, defaultElement$1), { component: {
                                name: 'Text',
                                options: {
                                    text: 'Tab 1 content',
                                },
...
var getRandomAspectTile = function () { return (tslib.__assign(tslib.__assign({}, defaultTile), { component: tslib.__assign(tslib.__assign({}, defaultTile.component), { options: tslib.__assign(tslib.__assign({}, defaultTile.component.options), { 
...
react.Builder.registerComponent(CarouselComponent, carouselConfig);
react.Builder.registerComponent(TabsComponent, tabsConfig);
react.Builder.registerComponent(AccordionComponent, accordionConfig);
react.Builder.registerComponent(MasonryComponent, masonryConfig);
//# sourceMappingURL=builder-widgets.cjs.js.map
