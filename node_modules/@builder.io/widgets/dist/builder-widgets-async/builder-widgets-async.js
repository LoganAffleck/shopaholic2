...
Builder.registerComponent(dynamic(function () { return import('./Carousel-b73bf947.js').then(function (mod) { return mod.CarouselComponent; }); }), carouselConfig);
...
Builder.registerComponent(dynamic(function () { return import('./Accordion-b6633f76.js').then(function (mod) { return mod.AccordionComponent; }); }), accordionConfig);
