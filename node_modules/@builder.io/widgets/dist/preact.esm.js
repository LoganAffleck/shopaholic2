...
import { createRef, createElement, Component, Fragment } from 'preact/compat';
...
var CarouselComponent = /** @class */ (function (_super) {
    ...
    CarouselComponent.prototype.render = function () {
        ...
        return (createElement(BuilderAsyncRequestsContext.Consumer, null, function (value) {
            ...
            return (createElement(BuilderStoreContext.Consumer, null, function (state) { return (createElement("div", { ref: _this.divRef, className: "builder-carousel" },
                ...
                createElement(Slider, __assign({ responsive: _this.props.responsive, ref: _this.sliderRef, afterChange: function (slide) {
                        var _a;
                        // TODO; callbacks
                        if (_this.divRef) {
                                ...
                                if (Array.isArray(array)) {
                                    ...
                                    return array.map(function (data, index) {
                                        ...
                                        return (createElement(BuilderStoreContext.Provider, { key: block.id, value: __assign(__assign({}, state), { state: childState }) },
                                            createElement(BuilderBlockComponent, { block: __assign(__assign({}, block), { repeat: null }), index: index, child /* TODO: fieldname? */: true })));
                                    });
                                }
                            }
                            return (createElement(BuilderBlockComponent, { key: block.id, block: block, index: index, child /* TODO: fieldname? */: true }));
                        })
                    : _this.props.slides &&
...
var AccordionComponent = /** @class */ (function (_super) {
    ...
    AccordionComponent.prototype.getAccordionItem = function (titleBlocks, detailBlocks, index, openGridItemOrder, onlyOneAtATime, fromChildren) {
        ...
        createElement(Fragment, { key: index },
            ...
            open && (createElement("div", { className: "builder-accordion-detail builder-accordion-detail-" + (open ? 'open' : 'closed'), style: __assign({ order: typeof openGridItemOrder === 'number' ? openGridItemOrder : undefined }, (grid && {
                    width: '100%',
                })) }, open &&
