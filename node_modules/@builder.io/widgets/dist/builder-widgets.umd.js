(function (factory) {
    typeof define === 'function' && define.amd ? define('@builder.io/widgets', factory) :
    factory();
}((function () { 'use strict';
    ...
    ***************************************************************************** */
    ...
    var Builder = /** @class */ (function () {
        ...
        Builder.prototype.processEventsQueue = function () {
            ...
            var host = this.host;
            fetch$1("".concat(host, "/api/v1/track"), {
                method: 'POST',
    ...
    */
    ...
    var EmotionCacheContext = react_2( // we're doing this to avoid preconstruct's dead code elimination in this one case
    ...
    var withEmotionCache = function withEmotionCache(func) {
      var render = function render(props, ref) {
        return react_5(EmotionCacheContext.Consumer, null, function (cache) {
          return func(props, cache, ref);
        });
      }; // $FlowFixMe


      return react_6(render);
    };
    ...
    if (!isBrowser$3) {
      ...
      function (_React$Component) {
        ...
        _proto.render = function render() {
          return react_5(EmotionCacheContext.Provider, this.state, this.props.children(this.state.value));
        };
      ...
      withEmotionCache = function withEmotionCache(func) {
        return function (props) {
          return react_5(EmotionCacheContext.Consumer, null, function (context) {
            if (context === null) {
              return react_5(BasicProvider, null, function (newContext) {
    ...
    var render = function render(cache, props, theme, ref) {
      ...
      if (!isBrowser$3 && rules !== undefined) {
        ...
        return react_5(react_7, null, react_5("style", (_ref = {}, _ref["data-emotion-" + cache.key] = serializedNames, _ref.dangerouslySetInnerHTML = {
          __html: rules
    ...
    withEmotionCache(function (props, cache, ref) {
      ...
      if (typeof props.css === 'function') {
        return react_5(ThemeContext.Consumer, null, function (theme) {
    ...
    var ClassNames = withEmotionCache(function (props, context) {
      return react_5(ThemeContext.Consumer, null, function (theme) {
        ...
        if (!isBrowser$3 && rules.length !== 0) {
          ...
          return react_5(react_7, null, react_5("style", (_ref = {}, _ref["data-emotion-" + context.key] = serializedHashes.substring(1), _ref.dangerouslySetInnerHTML = {
            __html: rules
    ...
    */
    ...
    var innerSliderUtils_1 = innerSliderUtils.clamp;
    var innerSliderUtils_2 = innerSliderUtils.canUseDOM;
    var innerSliderUtils_3 = innerSliderUtils.slidesOnLeft;
    var innerSliderUtils_4 = innerSliderUtils.slidesOnRight;
    var innerSliderUtils_5 = innerSliderUtils.siblingDirection;
    var innerSliderUtils_6 = innerSliderUtils.getTotalSlides;
    var innerSliderUtils_7 = innerSliderUtils.getPostClones;
    var innerSliderUtils_8 = innerSliderUtils.getPreClones;
    var innerSliderUtils_9 = innerSliderUtils.getTrackLeft;
    var innerSliderUtils_10 = innerSliderUtils.getTrackAnimateCSS;
    var innerSliderUtils_11 = innerSliderUtils.getTrackCSS;
    var innerSliderUtils_12 = innerSliderUtils.checkSpecKeys;
    var innerSliderUtils_13 = innerSliderUtils.getSlideCount;
    var innerSliderUtils_14 = innerSliderUtils.checkNavigable;
    var innerSliderUtils_15 = innerSliderUtils.getNavigableIndexes;
    var innerSliderUtils_16 = innerSliderUtils.swipeEnd;
    var innerSliderUtils_17 = innerSliderUtils.swipeMove;
    var innerSliderUtils_18 = innerSliderUtils.swipeStart;
    var innerSliderUtils_19 = innerSliderUtils.keyHandler;
    var innerSliderUtils_20 = innerSliderUtils.changeSlide;
    var innerSliderUtils_21 = innerSliderUtils.slideHandler;
    var innerSliderUtils_22 = innerSliderUtils.initializedState;
    var innerSliderUtils_23 = innerSliderUtils.extractObject;
    var innerSliderUtils_24 = innerSliderUtils.canGoNext;
    var innerSliderUtils_25 = innerSliderUtils.getSwipeDirection;
    var innerSliderUtils_26 = innerSliderUtils.getHeight;
    var innerSliderUtils_27 = innerSliderUtils.getWidth;
    var innerSliderUtils_28 = innerSliderUtils.lazySlidesOnRight;
    var innerSliderUtils_29 = innerSliderUtils.lazySlidesOnLeft;
    var innerSliderUtils_30 = innerSliderUtils.lazyEndIndex;
    var innerSliderUtils_31 = innerSliderUtils.lazyStartIndex;
    var innerSliderUtils_32 = innerSliderUtils.getRequiredLazySlides;
    var innerSliderUtils_33 = innerSliderUtils.getOnDemandLazySlides;
    var innerSliderUtils_34 = innerSliderUtils.safePreventDefault;
    ...
    var CarouselComponent = /** @class */ (function (_super) {
        ...
        function CarouselComponent() {
            ...
            _this.divRef = react_3();
            _this.sliderRef = react_3();
            return _this;
        }
        CarouselComponent.prototype.componentDidMount = function () {
            ...
            setTimeout(function () {
                var _a;
                (_a = _this.divRef.current) === null || _a === void 0 ? void 0 : _a.dispatchEvent(new CustomEvent('builder:carousel:load', {
                    bubbles: true,
                    cancelable: false,
                    detail: {
                        block: _this.props.builderBlock,
                        carousel: _this.sliderRef.current,
                    },
                }));
            });
        };
        CarouselComponent.prototype.render = function () {
            ...
            return (react_5(BuilderAsyncRequestsContext.Consumer, null, function (value) {
                _this._errors = value && value.errors;
                _this._logs = value && value.logs;
                return (react_5(BuilderStoreContext.Consumer, null, function (state) { return (react_5("div", { ref: _this.divRef, className: "builder-carousel" },
                    Builder.isServer ? (react_5("style", { type: "text/css", dangerouslySetInnerHTML: { __html: slickStyles } })) : (react_5("style", { type: "text/css" }, slickStyles)),
                    react_5(Slider, __assign({ responsive: _this.props.responsive, ref: _this.sliderRef, afterChange: function (slide) {
                            var _a;
                            // TODO; callbacks
                            if (_this.divRef) {
                                (_a = _this.divRef.current) === null || _a === void 0 ? void 0 : _a.dispatchEvent(new CustomEvent('builder:carousel:change', {
                                    bubbles: true,
                                    cancelable: false,
                                    detail: {
                                        slide: slide,
                        ...
                        // OOF!!
                        nextArrow: react_5("div", null,
                            react_5(BuilderBlocks, { parentElementId: _this.props.builderBlock.id, dataPath: "component.options.prevButton", blocks: _this.props.prevButton })), 
                        // OOF!!
                        prevArrow: react_5("div", null,
                            react_5(BuilderBlocks, { parentElementId: _this.props.builderBlock.id, dataPath: "component.options.nextButton", blocks: _this.props.nextButton })) }, _this.props.slickProps), _this.props.useChildrenForSlides
                                ...
                                if (block.repeat && block.repeat.collection) {
                                    ...
                                    if (Array.isArray(array)) {
                                        ...
                                        return array.map(function (data, index) {
                                            ...
                                            var childState = __assign(__assign({}, state.state), (_a = {}, _a[itemName_1] = data, _a.$index = index, _a.$item = data, _a));
                                            return (react_5(BuilderStoreContext.Provider, { key: block.id, value: __assign(__assign({}, state), { state: childState }) },
                                                react_5(BuilderBlock$1, { block: __assign(__assign({}, block), { repeat: null }), index: index, child /* TODO: fieldname? */: true })));
                                        });
                                    }
                                }
                                return (react_5(BuilderBlock$1, { key: block.id, block: block, index: index, child /* TODO: fieldname? */: true }));
                            })
                        : _this.props.slides &&
                            ...
                            react_5(BuilderBlocks, { key: index, parentElementId: _this.props.builderBlock && _this.props.builderBlock.id, dataPath: "component.options.slides." + index + ".content", child: true, blocks: slide.content || slide })); })))); }));
            }));
        };
        ...
        TabsComponent.prototype.render = function () {
            ...
            return (react_5(react_7, null,
                react_5("span", { style: {
                    ...
                    this.props.tabs.map(function (item, index) { return (react_5("span", { key: index, className: 'builder-tab-wrap ' + (_this.activeTabSpec === item ? 'builder-tab-active' : ''), style: __assign({}, ((_this.activeTabSpec === item && _this.props.activeTabStyle) || undefined)), onClick: function () {
                ...
                this.activeTabSpec && (react_5(BuilderBlocks, { parentElementId: this.props.builderBlock.id, dataPath: "component.options.tabs." + this.state.activeTab + ".content", blocks: this.activeTabSpec.content }))));
        };
    ...
    var AccordionComponent = /** @class */ (function (_super) {
        ...
        AccordionComponent.prototype.getAccordionItem = function (titleBlocks, detailBlocks, index, openGridItemOrder, onlyOneAtATime, fromChildren) {
            ...
            react_5(react_7, { key: index },
                react_5("div", { className: "builder-accordion-title builder-accordion-title-" + (open ? 'open' : 'closed'), style: __assign({ cursor: 'pointer', display: 'flex', flexDirection: 'column', alignItems: 'stretch' }, (grid && __assign({ width: this.props.gridRowWidth }, (typeof openGridItemOrder === 'number' && {
                    ...
                    } }, fromChildren ? (titleBlocks.map(function (block, index) { return (react_5(BuilderBlock$1, { key: index, block: __assign(__assign({}, block), { repeat: null }), index: index, child: true })); })) : (react_5(BuilderBlocks, { blocks: titleBlocks, dataPath: "items." + index + ".title" }))),
                open && (react_5("div", { className: "builder-accordion-detail builder-accordion-detail-" + (open ? 'open' : 'closed'), style: __assign({ order: typeof openGridItemOrder === 'number' ? openGridItemOrder : undefined }, (grid && {
                        width: '100%',
                    })) }, open &&
                    (fromChildren ? (detailBlocks.map(function (block, index) { return (react_5(BuilderBlock$1, { key: index, block: __assign(__assign({}, block), { repeat: null }), index: index, child: true })); })) : (react_5(BuilderBlocks, { blocks: detailBlocks, dataPath: "items." + index + ".detail" })))))));
        };
        AccordionComponent.prototype.render = function () {
            ...
            return (react_5(BuilderAsyncRequestsContext.Consumer, null, function (value) {
                _this._errors = value && value.errors;
                _this._logs = value && value.logs;
                return (react_5(BuilderStoreContext.Consumer, null, function (state) { return (react_5("div", { ref: function (ref) { return (_this.divRef = ref); }, className: "builder-accordion", style: __assign({ display: 'flex', alignItems: 'stretch', flexDirection: 'column' }, (grid && {
                        flexDirection: 'row',
                            ...
                            if (block.repeat && block.repeat.collection) {
                                ...
                                if (Array.isArray(array)) {
                                    return array.map(function (data, index) {
                                        ...
                                        return (react_5(BuilderStoreContext.Provider, { key: block.id, value: __assign(__assign({}, state), { state: childState }) }, _this.getAccordionItem(block.children ? [block.children[0]] : [], block.children ? [block.children[1]] : [], index, openGridItemOrder, onlyOneAtATime, true)));
                                    });
                                }
                            }
    ...
    **/
     ...
     * // => { 'b': '2' }
     */
    var omit$3 = _flatRest(function(object, paths) {
      var result = {};
      if (object == null) {
        return result;
      }
    ...
    var Masonry = isBrowser$5 ? window.Masonry || masonry : null;
    var imagesloaded$1 = isBrowser$5 ? imagesloaded : null;
    ...
    var MasonryComponent$1 = /** @class */ (function (_super) {
        ...
        MasonryComponent.prototype.render = function () {
            ...
            return (react_5("div", { style: {
                    opacity: Builder.isBrowser && this.state.layoutComplete ? 1 : 0,
                    transition: 'opacity 0.2s',
                } },
                react_5(BuilderAsyncRequestsContext.Consumer, null, function (value) {
                    _this._errors = value && value.errors;
                    _this._logs = value && value.logs;
                    return (react_5(BuilderStoreContext.Consumer, null, function (state) { return (react_5("div", { ref: function (ref) { return (_this.divRef = ref); }, className: "builder-masonry" },
                        react_5(lib$1, { onLayoutComplete: function () {
                                    ...
                                    if (block.repeat && block.repeat.collection) {
                                        ...
                                        if (Array.isArray(array)) {
                                            ...
                                            return array.map(function (data, index) {
                                                ...
                                                // TODO: Builder state produce the data
                                                var childState = __assign(__assign({}, state.state), (_a = { $index: index, $item: data }, _a[itemName_1] = data, _a));
                                                return (react_5("div", { className: "masonry-item", style: itemStyle },
                                                    react_5(BuilderStoreContext.Provider, { key: block.id, value: __assign(__assign({}, state), { state: childState }) },
                                                        react_5(BuilderBlock$1, { block: __assign(__assign({}, block), { repeat: null }), index: index, child: true }))));
                                            });
                                        }
                                    }
                                    return (react_5("div", { style: itemStyle, className: "masonry-item" },
                                        react_5(BuilderBlock$1, { key: block.id, block: block, index: index, child: true })));
                                })
                            : _this.props.tiles &&
                                ...
                                react_5("div", { style: itemStyle, className: "masonry-item" },
                                    react_5(BuilderBlocks, { key: index, parentElementId: _this.props.builderBlock && _this.props.builderBlock.id, dataPath: "component.options.tiles." + index + ".content", child: true, blocks: tile.content || tile }))); })))); }));
                })));
        };
    ...
    Builder.registerComponent(MasonryComponent$1, masonryConfig);

})));
//# sourceMappingURL=builder-widgets.umd.js.map
